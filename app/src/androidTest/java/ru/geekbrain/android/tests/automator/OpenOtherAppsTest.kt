...
//Хардкод можно заменить на uiDevice.displayWidth/2, uiDevice.displayHeight-50, uiDevice.displayWidth/2, 0, 10
...
//и найти Apps на главном экране
        ...
        val allAppsButton: UiObject = uiDevice.findObject(UiSelector().description("Telegram"))
...
//Находим в контейнере настройки по названию иконки
       ...
       /* val settingsApp = appViews.getChildByText(
        ...
        val settingValidation = uiDevice.findObject(UiSelector().packageName("org.telegram.messenger"))
        Assert.assertTrue(settingValidation.exists())
    }
}